...
class _Round4ScreenState extends State<Round4Screen> {
  ...
  Future<void> load() async {
    ...
    print("ROUND 4 LOAD START");

    final data = await weekRepository.loadWeekRecords();
    final selection = await selectionService.getSelection(userId: Session.userId!, roundNumber: 4);
  ...
  Widget build(BuildContext context) {
    ...
    print("WEEKS LENGTH ROUND 4 SEL SCN: ${weeks.length}");
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.black,
        centerTitle: true,
        title: Text("Round 4 Week Selection",
          style: TextStyle(
            color: Colors.grey,
            ...
            ElevatedButton(
              ...
              : () async {
                ...
                try {
                  ...
                  final created = await selectionService.createSelection(userId: Session.userId!, weekId: selectedWeekId!, roundNumber: 4);
